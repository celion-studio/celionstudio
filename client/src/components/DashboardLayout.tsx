        ...
        <div className="flex flex-col items-center gap-8 p-8 max-w-md w-full">
          <div className="flex flex-col items-center gap-2">
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="text-2xl font-bold tracking-tight">SellMate</span>
            </div>
        ...
        >
          ...
          <SidebarFooter className="p-3">
            {!isCollapsed && subscriptionStatus === "free" && (
              <button
                onClick={() => setLocation("/pricing")}
                className="flex items-center gap-2 rounded-lg bg-primary/10 border border-primary/20 px-3 py-2 mb-2 text-sm text-primary hover:bg-primary/15 transition-colors w-full"
              >
