...
export function PageFormatControl({
  ...
  return (
    <div style={{ position: "relative" }}>
      ...
      >
        {selected.label}
        <span style={{ color: "#8f969f", fontWeight: 500 }}>
          {selected.id === "custom"
      ...
      {open ? (
        <div
          style={{
            ...
            boxShadow: "0 14px 40px rgba(24, 27, 31, 0.12)",
            padding: "10px",
            fontFamily: "'Geist', sans-serif",
          }}
        >
          <div style={{ padding: "4px 4px 8px" }}>
            <p style={{ margin: 0, color: "#8f969f", fontSize: "10.5px", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase" }}>
              Ebook
            </p>
          </div>
          {ebookFormats.map((format) => (
            <button
              ...
              style={{
                ...
                border: 0,
                borderRadius: "4px",
                background: value === format.id ? "#eef0f3" : "transparent",
                color: "#17191d",
                padding: "8px",
                textAlign: "left",
                cursor: "pointer",
            ...
            >
              ...
              <span style={{ fontSize: "11px", color: "#858b93" }}>
                {format.widthMm} x {format.heightMm}
              </span>
              <span style={{ gridColumn: "1 / -1", fontSize: "11.5px", color: "#858b93" }}>
                {format.description}
              </span>
            </button>
          ))}

          <div style={{ margin: "8px 0", height: "1px", background: "#e4e6e9" }} />
          <div style={{ padding: "4px 4px 8px" }}>
            <p style={{ margin: 0, color: "#8f969f", fontSize: "10.5px", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase" }}>
              Print
            </p>
            ...
            {printFormats.map((format) => (
              <button
                ...
                style={{
                  ...
                  border: "1px solid #e1e4e8",
                  borderRadius: "4px",
                  background: value === format.id ? "#17191d" : "#ffffff",
                  color: value === format.id ? "#ffffff" : "#4b515a",
                  fontSize: "12px",
                  fontWeight: 650,
                  cursor: "pointer",
                }}
          ...
          <div style={{ margin: "10px 0", height: "1px", background: "#e4e6e9" }} />
          <div style={{ padding: "4px" }}>
            <p style={{ margin: "0 0 8px", color: "#8f969f", fontSize: "10.5px", fontWeight: 700, letterSpacing: "0.14em", textTransform: "uppercase" }}>
              Custom
            </p>
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
              <label style={{ display: "grid", gap: "4px", fontSize: "11px", color: "#858b93" }}>
                Width
                <input
                  type="number"
                  min={50}
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "4px",
                background: value === "custom" ? "#17191d" : "#ffffff",
                color: value === "custom" ? "#ffffff" : "#17191d",
                fontSize: "12px",
                fontWeight: 650,
                cursor: "pointer",
              }}
