    ...
    >
      ...
      >
        ...
        >
          ...
          <div className="mb-6 flex h-9 w-9 items-center justify-center rounded-[6px] bg-[#1F1F1F]">
          ...
          <div className="mt-6 flex rounded-[6px] border border-black/[0.06] bg-[#f1f2f4] p-[3px]">
          ...
          <button
            ...
            className="mt-5 flex w-full items-center justify-center gap-2.5 rounded-[6px] border border-black/[0.08] bg-white py-[11px] text-[14px] font-medium text-[#1F1F1F] shadow-[0_1px_2px_rgba(0,0,0,0.04)] transition hover:bg-[#f1f2f4] disabled:cursor-not-allowed disabled:opacity-50"
          >
            <GoogleIcon />
          ...
          <button
            ...
            disabled={!canSubmit}
            className="mt-4 w-full rounded-[6px] bg-[#1F1F1F] py-[11px] text-[14px] font-medium text-white transition hover:opacity-80 disabled:cursor-not-allowed disabled:opacity-40"
          >
            {loading === "email"
              ? "Working..."
              : mode === "sign-up"
